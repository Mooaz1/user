...
class MyNotification {
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    var iOSInitialize = new DarwinNotificationDetails();
    var initializationsSettings = new InitializationSettings(android: androidInitialize, iOS:DarwinInitializationSettings() );
    flutterLocalNotificationsPlugin.initialize(initializationsSettings,onDidReceiveNotificationResponse: (details) {
        ...
        if(details.payload != null &&details.payload.isNotEmpty) {
          MyApp.navigatorKey.currentState.push(
              MaterialPageRoute(builder: (context) => OrderDetailsScreen(orderModel: null, orderId: int.parse(details.payload),orderType: 'default_type',)));
        }
      }catch (e) {}
      return;
    },);
